...
namespace Microsoft.Data.Entity.Internal
{
    ...
    public class MakeGenericMethodCodeFixProvider : CodeFixProvider
    {
        ...
        private const string AttrNamespace = "Microsoft.EntityFrameworkCore.Internal";

        private async Task<Document> AddAttribute(Document document, SyntaxNode root, MethodDeclarationSyntax methodDeclaration)
        {
            var newAttribute = SyntaxFactory.Attribute(SyntaxFactory.ParseName("CallsMakeGenericMethod"), SyntaxFactory.ParseAttributeArgumentList("(MethodName = nameof(), TypeArguments = new [] { }, TargetType = typeof())"));
